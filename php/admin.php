...
<thead>
  ...
  <tbody>
    ...
    <th scope="col"><?php echo $user['id']; ?></th>
      ...
      <th scope="col"><a  href="edit.php?id=<?php echo $user['id'] ?>"><i class="uil uil-edit"></i></a></th>
      <th scope="col"><a class="delbutton"  href="delete.php?id=<?php echo $user['id'] ?>"><i class="uil uil-trash-alt"></i></a></th>
    </tr>
    <?php }?>
    </tbody>
</table>
